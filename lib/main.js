...
const processCsv_1 = require("./processCsv");
const processNotion_1 = require("./processNotion");
const uploadToGit_1 = require("./uploadToGit");
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!filePath) {
                ...
                const notionId = core.getInput("notionId");
                if (!notionId || !notionSecret) {
                    return core.setFailed("Missing inputs information to parse translation.");
                }
                files = yield (0, processNotion_1.processNotion)(notionSecret, notionId);
            }
